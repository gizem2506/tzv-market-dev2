...
export default function DropZoneMulti({
  onChange,
  imageSize = "280*280 görüntü yükleyin",
  title = "Ürün resmini buraya sürükleyip bırakın"
}) {
  const onDrop = useCallback(acceptedFiles => {
    //const filesWithPreview = acceptedFiles.map(file => ({...file, preview: URL.createObjectURL(file)}));
